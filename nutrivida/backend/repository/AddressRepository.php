...
class AddressRepository {
    ...
    public function updateAddress($address) {
        try {
            ...
            return $query->execute([
                ...
                'number'       => $address->getNumber(),
                'zip_code'     => $address->getZipCode(),
                'fk_patient_id'  => $address->getFkPatientId(),
                'id'           => $address->getId()
            ]);
        } catch (PDOException $e) {
            throw $e;
    ...
    public function selectAddress($id) {
        try {
            $query = $this->pdo->prepare("SELECT * FROM address WHERE id = :id");
            $query->execute(['id' => $id]);
    ...
    public function selectAddressByPatient($fkPatientId) {
        try {
            ...
            $query->execute(['fk_patient_id' => $fkPatientId]);
            return $query->fetchAll(PDO::FETCH_ASSOC);
        } catch (PDOException $e) {
            throw $e;
        }
    ...
    public function deleteAddress($id) {
        try {
            $query = $this->pdo->prepare("DELETE FROM address WHERE id = :id");
